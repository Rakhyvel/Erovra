...
public class GameMenu extends Menu {
	...
	public void render(Render r) {
		if (Main.gameState == StateID.VICTORY) {
			r.drawString("Victory!", 512, 160, r.font32, 23 << 16 | 128 << 8 | 230,1);
			r.drawString("Time: " + Main.ticks / 3600 + " minutes", 512, 192, r.font16, 255 << 16 | 255 << 8 | 255,1);
			drawButton("Main Menu", 512, 256, 2, r);
			drawButton("Exit", 512, 304, 3, r);
		} else if (Main.gameState == StateID.DEFEAT) {
			r.drawString("Defeat!", 512, 160, r.font32, 230 << 16 | 23 << 8 | 23,1);
			r.drawString("Time: " + Main.ticks / 3600 + " minutes", 512, 192, r.font16, 255 << 16 | 255 << 8 | 255,1);
			drawButton("Main Menu", 512, 256, 2, r);
			drawButton("Exit", 512, 304, 3, r);
