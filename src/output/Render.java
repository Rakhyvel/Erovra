...
public class Render extends Canvas {
	 ...
	 * 
	 * @param x
	 *            The x coordinate of the top left corner of the letter
	 * @param y
	 *            The y coordinate of the top right corner of the letter
	 * @param w
	 *            The width of the image
	 * @param image
	 *            The image
	 * @param color
	 *            The color to be blended
	 */
